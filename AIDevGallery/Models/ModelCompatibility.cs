    ...
    public static ModelCompatibility GetModelCompatibility(ModelDetails modelDetails)
    {
        ...
        else if (ModelTypeHelpers.ApiDefinitionDetails.Any(md => md.Value.Id == modelDetails.Id))
        {
            ...
            else
            {
                ...
                description = $"{WcrApiHelpers.GetStringDescription(apiType, availbility)} This Windows AI API requires a Copilot+ PC and a Windows 11 Insider Preview Build 26120.3073.";
            }
        }
