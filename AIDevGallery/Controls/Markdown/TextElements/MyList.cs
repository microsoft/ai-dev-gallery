    ...
    public void AddChild(IAddChild child)
    {
        ...
        if (_isOrdered)
        {
            bullet = _bulletType switch
            {
                ...
                BulletType.UpperAlpha => $"{_index.ToAlphabetical().ToUpperInvariant()}. ",
                BulletType.LowerRoman => $"{_index.ToRomanNumerals().ToLowerInvariant()} ",
                BulletType.UpperRoman => $"{_index.ToRomanNumerals().ToUpperInvariant()} ",
